...
<body>
    <div class="container mt-sm-5 my-1">
        <div class="question ml-sm-5 pl-sm-5 pt-2">
            <div class="py-2 h5"><b>Q. Whom do u like more?</b></div>
            <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options"> 
                <label class="options">Channa <input type="radio" name="radio"  value="Channa"> 
                    <span class="checkmark"></span> </label>
                     <label class="options">Rash <input type="radio" name="radio"  value="Rash"> 
                        <span class="checkmark"></span> </label> 
                        <label class="options">Egg Rice <input type="radio" name="radio"  value="Egg Rice"> 
                            <span class="checkmark"></span> </label> 
                        </div>
        ...
        function validate() {
            ...
            for(i = 0; i < ele.length; i++) {
                if(ele[i].checked){
                        ...
                        if(ele[i].value == "Egg Rice" && login_attempts>0)
                        location.replace("L6.php")
                        else{
