...
<body>
    <div class="container mt-sm-5 my-1">
        <div class="question ml-sm-5 pl-sm-5 pt-2">
            <div class="py-2 h5"><b>Q. You like tuesday panner maore than thursday panner</b></div>
            <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options"> 
                <label class="options">True <input type="radio" name="radio"  value="True"> 
                    <span class="checkmark"></span> </label>
                     <label class="options">False <input type="radio" name="radio"  value="False"> 
                        <span class="checkmark"></span> </label> 
                        <!-- <label class="options">789 <input type="radio" name="radio"  value="789"> 
                            <span class="checkmark"></span> </label>  -->
                        </div>
        ...
        function validate() {
            ...
            for(i = 0; i < ele.length; i++) {
                if(ele[i].checked){
                        ...
                        if(ele[i].value == "True" && login_attempts>0)
                        location.replace("L3.php")
                        else{
